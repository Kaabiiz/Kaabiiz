...
**Features:**
- 📱 Interactive OpenStreetMap with 6+ building types
- 📅 Smart room reservation system with email confirmations
- 📍 Custom POI management (12 categories: parking, wifi, cafeteria, etc.)
- 🔍 Advanced search across buildings, rooms, and points of interest
- 🟢🟠🔴 Color-coded room occupancy tracking
- 💾 SQLite database for local persistence  

🛠️ *Flutter · Dart · SQLite · OpenStreetMap · Material Design*  
🔗 [View Repository](https://github.com/Kaabiiz/smart-campus-map)
...
<p align="center">
  ...
  <a href="https://github.com/Kaabiiz" target="_blank">
